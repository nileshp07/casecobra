					...
					<div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
						<div className='relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start'>
							...
							<p className='mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap'>
								Capture your memories with your own <span className='font-semibold'>one-of-one</span> phone case.
								CaseCobra lets you protect your memories, not just your phone.
							</p>
							<ul className='mt-8 space-y-2 flex flex-col text-left font-medium items:center sm:items-start'>
								<div className='space-y-2'>
									...
									<li className='flex gap-1.5 items-center text-left'>
										<Check className='h-5 w-5 shrink-0 text-green-600' />
										Modern iphone models available
									</li>
								</div>
							</ul>
					...
					<div className='mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16'>
						<div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
							...
							<div className='text-lg leading-8'>
								<p>
									&quot;The case feels durable and I even got a compliment on the design. Had the case for two and a
									half months now and <span className='p-0.5 bg-slate-800 text-white'>the image is super clear</span>,
									on the case I had before, the image started fading into yellow-ish color after a couple weeks. Love
									it.&quot;
								</p>
							</div>
							<div className='flex gap-4 mt-2'>
								...
								<div className='flex flex-col'>
									...
									<div className='flex gap-1.5 items-center text-zinc-600'>
										<Check className='h-4 w-4 items-center text-green-600' />
						...
						<div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
							...
							<div className='text-lg leading-8'>
								<p>
									&quot;I usually keep my phone together with my keys in my pocket and that led to some pretty heavy
									scratchmarks on all of my last phone cases. This one, besides a barely noticeable scratch on the
